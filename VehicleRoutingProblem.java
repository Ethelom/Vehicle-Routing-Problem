...
public class VehicleRoutingProblem {
    ...
    private boolean MoveIsImproving(int k, RelocationMove rm, SwapMove sm, TwoOptMove top) 
    {
        ...
        {
            if ((top.getNewMaxRouteWithThisTwoOptMove() <  maxRoute.getTotalRouteTimeInHrs())  || (maxRoute.getTotalRouteTimeInHrs() == top.getNewMaxRouteWithThisTwoOptMove()  && (top.getMoveCost() < -0.001)))
            {
                return true;
            }
        }
    ...
    private void ApplySwapMove(SwapMove sm) {
        ...
        if (firstRoute == secondRoute) {
            ...
            firstRoute.setTotalRouteTimeInHrs1(sm.getMoveCost());
        } else {
            ...
            firstRoute.setTotalRouteTimeInHrs1(costChangeFirstRoute);
            secondRoute.setTotalRouteTimeInHrs1(costChangeSecondRoute);
    ...
    private void ApplyTwoOptMove(TwoOptMove top) 
    {
        ...
        {	
            ...
            rt1.setTotalRouteTimeInHrs1(top.getMoveCost());
        }
        else
        {
